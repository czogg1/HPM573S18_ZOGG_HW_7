...
class Cohort:
    def __init__(self, id, pop_size, mortality_prob):
        ...
        self._livedFiveYears = []       # list to store if no death within 5y for each patient
        self._n_livedFiveYears = 0
        self._5y_survival_probability = 0
    ...
    def simulate(self, n_time_steps):
        ...
        # store and count deaths within 5y
        for time in self._survivalTimes:
            if time < 5:
                self._livedFiveYears.append(0)
            else:
                self._n_livedFiveYears += 1
                self._livedFiveYears.append(1)

        # calculate 5y survival probability
        self._5y_survival_probability = self._n_livedFiveYears / self._initialPopSize
    ...
    def get_5y_survival_probability(self):
        """ :returns the 5y survival probability for this cohort"""
        return self._5y_survival_probability
...
class CohortOutcomes:
    ...
    def get_5y_survival(self):
        """ :returns the probability of 5y survival among patients in this cohort"""
        return self._simulatedCohort.get_5y_survival_probability()
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._5y_survival_probabilities = []
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            # store 5y survival probabilities for this cohort
            self._5y_survival_probabilities.append(cohort.get_5y_survival_probability())
    ...
    def get_all_5y_survival_probability(self):
        """ returns: a lit of 5y survival porobabilities for for all simulate cohorts"""
        return self._5y_survival_probabilities

    def get_cohort_5y_survival_probability(self, cohort_index):
        """ returns the 5y survival probability of a specified cohort
        :param cohort_index: integer over [0, 1, ...] corresponding to the 1st, 2ndm ... simulated cohort
        """
