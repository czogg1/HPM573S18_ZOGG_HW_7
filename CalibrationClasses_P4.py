...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            # get the  5y survival for this cohort
            q = multiCohort.get_cohort_5y_survival_probability(cohort_id)
            ...
            weight = stat.binom.pmf(n=CalibSets.OBS_N, k=CalibSets.OBS_K, p=q)
